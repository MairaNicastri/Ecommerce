...
__webpack_require__(/*! ./js */ "./resources/js/js.js");
...
var navbar = document.querySelector("#bgnav");
var accettati = document.querySelector("#accettati");
var rifiutati = document.querySelector("#rifiutati");
var istruzioni = document.querySelector("#istruzioni");
var sezioniannunci = document.querySelector("#sezioniannunci");
...
accettati.addEventListener('click', function () {
  istruzioni.classList.add('d-none');
  sezioniannunci.classList.remove('d-none');
});
rifiutati.addEventListener('click', function () {
  istruzioni.classList.add('d-none');
  sezioniannunci.classList.remove('d-none');
});
